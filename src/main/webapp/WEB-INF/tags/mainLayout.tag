					...
					<sec:authorize access="hasRole('ROLE_ALUNO')">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a
									href="${pageContext.request.contextPath}/HistoricoEscolar/historicoEscolarAluno">
										Histórico Escolar </a></li>
								<li><a
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a
									href="${pageContext.request.contextPath}/HistoricoEscolar/historicoEscolarAdmin">
										Obter Históricos Escolares </a></li>
								<li><a
